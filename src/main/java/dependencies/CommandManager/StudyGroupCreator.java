...
public class StudyGroupCreator {
    ...
    private static boolean isDigitFloat(String s) throws NumberFormatException{
        try{
            Float.parseFloat(s);
            return true;
        } catch (NumberFormatException e){
    ...
    private static boolean containsSemester(String str) {
    ...
    private static boolean containsCountry(String str) {
    ...
    public static StudyGroup constructor(Long id, String groupName, String groupCurrentSemester, String xCoordinate, String yCoordinate, String studentsAmount, String adminName,
